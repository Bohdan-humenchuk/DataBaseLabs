...
CREATE TABLE IF NOT EXISTS `mydb`.`book` (
  ...
  `performer_idperformer1` INT NOT NULL,
  `customer_idcustomer1` INT NOT NULL,
  PRIMARY KEY (`idbooks`, `customer_idcustomer1`, `performer_idperformer1`),
  INDEX `fk_books_printer1_idx` (`printer_idprinter` ASC) VISIBLE,
  UNIQUE INDEX `idbooks_UNIQUE` (`idbooks` ASC) VISIBLE,
  INDEX `fk_book_performer2_idx` (`performer_idperformer1` ASC) VISIBLE,
  INDEX `fk_book_customer1_idx` (`customer_idcustomer1` ASC) VISIBLE,
  CONSTRAINT `fk_books_printer1`
    FOREIGN KEY (`printer_idprinter`)
    REFERENCES `mydb`.`printer` (`idprinter`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_book_performer2`
    FOREIGN KEY (`performer_idperformer1`)
...
CREATE TABLE IF NOT EXISTS `mydb`.`shop_has_book` (
  ...
  `book_customer_idcustomer1` INT NOT NULL,
  `book_performer_idperformer1` INT NOT NULL,
  INDEX `fk_shop_has_book_book1_idx` (`book_idbooks` ASC, `book_customer_idcustomer1` ASC, `book_performer_idperformer1` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_shop_has_book_book1`
    FOREIGN KEY (`book_idbooks` , `book_customer_idcustomer1` , `book_performer_idperformer1`)
    REFERENCES `mydb`.`book` (`idbooks` , `customer_idcustomer1` , `performer_idperformer1`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
