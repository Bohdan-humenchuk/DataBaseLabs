...
##ALTER TABLE size 
##drop foreign key fk_size_printer1, 
##drop index fk_size_printer1_idx; 
...
ALTER TABLE book_print
	MODIFY bookid INT(32) UNSIGNED NOT NULL,
	ADD COLUMN versionID TINYINT(8) UNSIGNED NOT NULL AFTER bookid,
	ADD CONSTRAINT UNIQUE UQ_book_version (bookid, versionID);
