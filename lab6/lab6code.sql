...
#create view performer3 as select distinct idperformer, name, emeil from performer; 
select * from performer3; 

select * from performer3 where idperformer>2 and idperformer<5;


select performer3.idperformer, performer3.name, performer.birth_date, performer3.emeil from performer3, performer 
where performer3.idperformer = performer.idperformer; 
