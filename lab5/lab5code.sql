...
insert into performer2
values (1, "Vasiliy2", "2014.12.11", "vasya2_homilka@gmail.com");
...
##select * from performer;
##select * from performer union select * from performer2;
##select * from performer where idperformer in (select idperformer from performer2);
##SELECT * FROM performer WHERE idperformer NOT IN (SELECT idperformer FROM performer2);

SELECT * FROM performer, performer2;