...
select idperformer, name, emeil from performer 
where emeil like "%gmail%" order by name asc; 

select name, emeil from performer 
order by emeil desc limit 4; 

select performer.name, performer.emeil, description 
